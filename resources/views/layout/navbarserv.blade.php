    ...
    <div class="px-4">
        <div class="flex items-center justify-between h-12 md:px-12">
            ...
            <div class="flex-shrink-0 flex justify-center">
                <a href="/">
                    <img class="h-10 md:h-12 w-auto" src="{{ asset('img/Logo-Bossku.png') }}" alt="Logo">
                </a>
            </div>
        ...
        >
            ...
            <a href="#" class="block px-4 py-2 text-sm font-medium hover:bg-gray-100">Experiences</a>
            <a href="Explore-Indonesia" class="block px-4 py-2 text-sm font-medium hover:bg-gray-100">Travel In Indonesia</a>
            <a href="#" class="block px-4 py-2 text-sm font-medium hover:bg-gray-100">Services</a>
